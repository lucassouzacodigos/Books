    ...
    return(
        ...
        <div className='FullPage flex-center' style={{backgroundColor:"white", height:"100%", flexDirection:"column"}}>
            ...
            <div className='flex-center' style={{backgroundColor:"white", width:"auto", height:"20%", position:"absolute", top:420, left:0}}>
                <div className='flex-center' style={{background:"#c22323", width:500, height:500, flexDirection:"column", borderRadius:15, position:"relative"}}>
                    <p onClick={() => setAba("")} style={{backgroundColor:"red", width:25, display:"flex", justifyContent:"center", alignItems:"center", position:"absolute", top:10, right:20, borderRadius:5}}>X</p>
            ...
            {aba == "editar" &&
            <div className='flex-center' style={{backgroundColor:"white", width:"auto", height:"20%", position:"absolute", top:420, left:0}}>
                <div className='flex-center' style={{background:"lightblue", width:500, height:500, flexDirection:"column", borderRadius:15, alignItems:"center", justifyContent:"center", position:"relative"}}>
                    <p onClick={() => setAba("")} style={{backgroundColor:"red", width:25, display:"flex", justifyContent:"center", alignItems:"center", position:"absolute", top:10, right:20, borderRadius:5}}>X</p>
            ...
            {aba == "criar" &&
            <div className='flex-center' style={{backgroundColor:"white", width:"auto", height:"20%", position:"absolute", top:420, left:0}}>
                <div className='flex-center' style={{background:"lightgreen", width:500, height:600, flexDirection:"column", borderRadius:15, position:"relative"}}>
                    <p onClick={() => setAba("")} style={{backgroundColor:"red", width:25, display:"flex", justifyContent:"center", alignItems:"center", position:"absolute", top:10, right:20, borderRadius:5}}>X</p>
